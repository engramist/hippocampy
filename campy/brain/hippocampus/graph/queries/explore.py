...
EXPLORE_QUERIES: tuple[NamedQuery, ...] = (
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:Concept) WHERE n.concept_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:Decision) WHERE n.decision_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:Constraint) WHERE n.constraint_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:Requirement) WHERE n.requirement_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:ActionItem) WHERE n.action_item_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:Lesson) WHERE n.lesson_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:Procedure) WHERE n.procedure_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:Plan) WHERE n.plan_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:MainQuest) WHERE n.quest_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:SideQuest) WHERE n.quest_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:Document) WHERE n.document_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
    ...
    NamedQuery(
        ...
        cypher="MATCH (n:Message) WHERE n.message_id = $id RETURN n, id(n) LIMIT 1",
        params=("id",),
        mutating=False,
