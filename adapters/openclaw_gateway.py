...
LAYER_2_ONBOARDING = (
    ...
    "- compile_context(query): Get a full pre-assembled context bundle (decisions, constraints, related "
    "tabular data, summaries) for broad or multi-entity questions - use this instead of memory_recall when "
    "the ask spans more than one topic, or for 'everything about X' / 'brief me on X' style questions\n"
