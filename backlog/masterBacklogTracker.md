...
| B10 | `explore_graph` Tool (Directed Graph Traversal) — ✅ DONE (2026-03-28) | P5 | complete | TBD | TBD | backlog/plans/B-10-explore-graph-tool.md | backlog/B10.md |
| B11 | `Lesson` Artifact Node — ✅ DONE (2026-03-28) | P5 | complete | TBD | TBD | backlog/plans/B-11-lesson-artifact-node.md | backlog/B11.md |
| B12 | Memory-Based Anomaly Detection (IP Formalization) — ✅ DONE (2026-03-28) | P5 | complete | TBD | TBD | backlog/plans/B-12-anomaly-detection.md | backlog/B12.md |
| B17 | Semantic Quest Routing ("The Hippocampus") — ✅ DONE (2026-03-28) | P5 | complete | TBD | TBD | backlog/plans/B-17-hippocampus.md, backlog/plans/B17-B18-architecture.md | backlog/B17.md |
| B18 | Context Window Awareness ("Working Memory") — ✅ DONE (2026-03-28) | P5 | complete | TBD | TBD | backlog/plans/B-18-working-memory.md, backlog/plans/B17-B18-architecture.md | backlog/B18.md |
| B14 | Proactive Insight Surfacing — ✅ DONE (2026-03-28) | P6 | complete | TBD | TBD | backlog/plans/B-14-insight-surfacing.md | backlog/B14.md |
| B15 | Deep-Link Handoff (Chat → Memory Control Panel) — ✅ DONE (2026-03-28) | P6 | complete | TBD | TBD | backlog/plans/B-15-deeplink-handoff.md | backlog/B15.md |
| B16 | Task-Based Model Routing — ✅ DONE (2026-03-23) | P6 | complete | TBD | TBD | - | backlog/B16.md |
| B20 | OpenClaw Extension: Plugin ID Mismatch — ✅ DONE (2026-03-28) | P7 | complete | TBD | TBD | backlog/plans/B-20-openclaw-plugin-id-mismatch.md | backlog/B20.md |
| B21 | OpenClaw System Prompt + Tool Integration (LLM Workflow) — ✅ DONE (2026-03-28) | P7 | complete | TBD | TBD | backlog/plans/B-21-openclaw-system-prompt.md | backlog/B21.md |
| B22 | OpenClaw Extension: `plugins.allow` Warning — ✅ DONE (2026-03-28) | P7 | complete | TBD | TBD | backlog/plans/B-22-openclaw-plugins-allow-warning.md | backlog/B22.md |
...
| B61 | OpenClaw Extension: Tools Not Surfaced to Agent Without Manual Config — ✅ DONE (2026-03-28) | P7 | complete | TBD | TBD | backlog/plans/B-61-openclaw-tools-surfacing.md | backlog/B61.md |
...
| B47 | Local Benchmark Runner Infrastructure (Unified Harness) — ✅ DONE (2026-03-28) | P11 | complete | TBD | TBD | backlog/plans/B-47-benchmark-infrastructure.md | backlog/B47.md |
| B48 | SideQuests A/B Evaluation Contract (Protocol-Correct) — ✅ DONE (2026-03-28) | P11 | complete | TBD | TBD | backlog/plans/B-48-ab-contract.md | backlog/B48.md |
| B49 | SWE-CI Evaluation Card (Maintainability Under Evolution) — ✅ DONE (2026-03-28) | P11 | complete | TBD | TBD | backlog/plans/B-49-swe-ci-eval.md | backlog/B49.md |
| B50 | LoCoBench Evaluation Card (Long-Context Degradation) — ✅ DONE (2026-03-28) | P11 | complete | TBD | TBD | backlog/plans/B-50-longcontext-eval.md | backlog/B50.md |
| B51 | AMA-Bench + MemoryArena Card (Causality and Interdependent State) — ✅ DONE (2026-03-28) | P11 | complete | TBD | TBD | backlog/plans/B-51-ama-bench-eval.md | backlog/B51.md |
| B52 | Autonomous Research Simulation Harness (Hypothesis Regression Rate) — ✅ DONE (2026-03-28) | P11 | complete | TBD | TBD | backlog/plans/B-52-research-sim.md | backlog/B52.md |
| B53 | Benchmark Report Pack + Go/No-Go Thresholds — ✅ DONE (2026-03-28) | P11 | complete | TBD | TBD | backlog/plans/B-53-benchmark-report.md | backlog/B53.md |
| B54 | ARC-AGI-3 Rules + Interface Verification (Blocker) — ✅ DONE (2026-03-28) | P12 | complete | TBD | TBD | - | backlog/B54.md |
| B55 | ARC Interactive Adapter (Protocol-Correct SideQuests Bridge) — ✅ DONE (2026-03-28) | P12 | complete | TBD | TBD | backlog/plans/B-55-arc-adapter.md | backlog/B55.md |
| B56 | Spatial State-to-Text/State Serializer for Causal Memory — ✅ DONE (2026-03-28) | P12 | complete | TBD | TBD | backlog/plans/B-56-arc-serializer.md | backlog/B56.md |
| B57 | ARC A/B Harness (Baseline vs SideQuests-Augmented) — ✅ DONE (2026-03-28) | P12 | complete | TBD | TBD | backlog/plans/B-57-arc-harness.md | backlog/B57.md |
...
|------|----------|-------|-------|-----------|
| B295 | P0 | complete (2026-07-13) | Green Main: Triage Every Failing Test Before Public Launch | backlog/B295.md |
| B296 | P0 | complete (2026-07-13) | Public-Tree Audit: Decide What Ships in the Public Repo | backlog/B296.md |
| B297 | P0 | complete (2026-07-13) | README + Install Path: Make the Front Door Work and Sell | backlog/B297.md |
| B294 | P1 | complete (2026-07-13) | Finish the mcp_engine Migration (Kill the Half-Moved Package) | backlog/B294.md |
| B292 | P1 | complete (2026-07-13) | Split the tools/__init__.py God Module | backlog/B292.md |
| B293 | P2 | complete (2026-07-13) | Single Source of Truth for the MCP Tool Surface | backlog/B293.md |
| B298 | P2 | complete (2026-07-13) | Piggyback Claude Code's Auto-Memory Writes into Campy | backlog/B298.md |
...
| B304 | P1 | complete (2026-08-02) | Ask-Eval Harness: Measure Models × Harness Variants for Local Synthesis | backlog/B304.md |
| B305 | P0 | complete (2026-08-02) | Bundle Relevance Floor: Stop Feeding Off-Topic Content to ask/Synthesis | backlog/B305.md |
| B306 | P0 | complete (2026-08-02) | Fix Invalid Cypher in `_stage_exact_facts` / `_stage_semantic_context` (Silently Dead Bundle Stages) | backlog/B306.md |
| B307 | P1 | complete (2026-08-02) | Lexical Bypass for Paraphrased Plan Queries (Retrieval Floor Too Strict) | backlog/B307.md |

**Dependency chain:** B295, B296, B297 are the P0 launch gates (independent of each other; B296 requires maintainer IP decisions and must complete before the repo goes public). B294 before B297's packaging work ideally (removes stray package from discovery). B292 → B293 (codegen is cleaner against split modules). Do NOT run B292 and B295 concurrently (both touch broad test surface). B298 should land after B292 if B292 is already merged (cleaner to extend the post-split module ownership of `notify_turn`), but is not blocked by it. B306 should land before or alongside B305 (B305's relevance floor is inert on these two stages until B306 fixes the underlying Cypher; B306 has no dependency on B305).
