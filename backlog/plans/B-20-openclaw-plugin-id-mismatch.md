...
- Identify current mismatch in `extensions/hippocampy/package.json` or manifest
...
- `extensions/hippocampy/package.json` — plugin ID alignment
- `extensions/hippocampy/.claude-plugin/plugin.json` — ID consistency
...
3. `openclaw plugins install --link extensions/hippocampy` succeeds
