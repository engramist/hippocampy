...
- The card complies with `docs/ecosystem-rules.md` (import boundaries, layer separation). Any card that touches historical ARC-related integration code must confirm no layer violations (see sibling `ARC_AGI` repo for agent-specific rules).
