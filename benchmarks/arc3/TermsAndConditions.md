By clicking on the "I Understand and Accept" button below, you agree to be bound by the competition rules for ARC Prize 2026 - ARC-AGI-3.
...
b. Bonus Prize: $700,000

(a) Top score track: $150,000
(a.1.) Final leaderboard prizes: $75,000
...
Fourth Prize: $5,000
Fifth Prize: $5,000
(a.2.) Milestone prizes: $75,000
These prizes are based on the leaderboard score on two specific dates throughout the competition. Participants should have published their Notebooks by the date specified in each milestone to be considered for these prizes.
...
a. Submissions are required to have open source system, open source model, and open source weights/parameters, as defined in the checklist from the Open Source AI definition by the Open Source Initiative.
...
a. Conduct an interview with the sponsor and work with a technical writer provided by the host to document their solution according to the host's standards
